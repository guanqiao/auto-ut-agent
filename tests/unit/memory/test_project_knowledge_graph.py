...
class TestProjectKnowledgeGraph:
    ...
    def test_get_outgoing_edges_with_type_filter(self):
        ...
        try:
            ...
            assert len(edges) >= 1
            assert all(e.relation_type == RelationType.CONTAINS for e in edges)
        finally:
            if os.path.exists(db_path):
                os.remove(db_path)
    ...
    def test_get_incoming_edges(self):
        ...
        try:
            ...
            assert len(edges) >= 1
            assert any(e.relation_type == RelationType.TESTS for e in edges)
        finally:
            if os.path.exists(db_path):
                os.remove(db_path)
    ...
    def test_get_neighbors(self):
        ...
        try:
            ...
            neighbors = graph.get_neighbors(class_id, direction="outgoing")
...
class TestGraphIntegration:
    ...
    def test_full_workflow(self):
        ...
        try:
            ...
            neighbors = graph.get_neighbors(service_id, direction="outgoing")
